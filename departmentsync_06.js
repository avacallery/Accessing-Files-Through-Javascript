...
//list department #, name, and how many people in the department 

for (var i = 0; i < departmentNames.length; i++){ 
        var departmentData = departmentNames[i][0] + ", " + departmentNames[i][1] + ": " + departmentEmployeesArray3D[i].length; 
        console.log(departmentData);
    }


//Create Report that generates the total salaries for each department 